        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              SalTech transforms ambitious ideas into robust digital solutions. From AI-driven analytics to scalable cloud architectures, we engineer success.
            </p>
            
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
              <Link to="/contact" className="w-full sm:w-auto px-8 py-4 rounded-full bg-accent hover:bg-accent-glow text-white font-semibold transition-all shadow-[0_0_20px_rgba(56,189,248,0.3)] hover:shadow-[0_0_30px_rgba(56,189,248,0.5)] flex items-center justify-center">
                Start a Project
          ...
          >
            <div className="relative w-full h-[500px] rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-primary-light/50 backdrop-blur-sm group">
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 border border-accent/20 rounded-full animate-[spin_10s_linear_infinite]"></div>
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 h-48 border border-purple-500/30 rounded-full animate-[spin_15s_linear_infinite_reverse]"></div>
              
              {/* Floating Cards Mockup */}
              <div className="absolute top-12 left-12 right-12 bottom-12 border border-white/5 rounded-xl bg-primary/80 p-6">
